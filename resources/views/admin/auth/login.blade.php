...
<head>
    ...
    <link rel="icon" href="{{ asset('backend/files/assets/images/fav.png') }}" type="image/x-icon">
                    ...
                    <form class="md-float-material form-material" method="post" action="{{ route('admin.login.submit') }}">
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="alert alert-danger icons-alert" style="margin:0">
                                            ...
                                            <p><strong>Error!</strong>  {{Session::get('error')}}
                                        </div>
                                          @endif
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <p class="text-inverse text-center m-b-0">Copyright © newproject All Rights Reserved</p>
                                    </div>
                                </div>
                            </div>
                        </div>
