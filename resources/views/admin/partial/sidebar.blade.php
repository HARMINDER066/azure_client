   ...
   <div class="pcoded-inner-navbar main-menu">
      ...
      <div class="profile--img" style="">
         <a href="{{ route('admin.dashboard') }}">
            <img src="{{ asset('backend/files/assets/images/admin.png') }}"  alt="" class="rounded-circle">
         </a>
      </div>
      <div class="profile--name" >
                    <a href="{{ route('admin.dashboard') }}" class="btn-link" >Admin</a>
                </div>
      <div class="profile--nav" >
         <ul class="nav" style="justify-content:center">
            <li class="nav-item">
               <a href="{{ route('admin.changeemail') }}" class="nav-link" title="User Profile">
      ...
      <ul class="pcoded-item pcoded-left-item">
         ...
         <li class="pcoded-hasmenu {{ (Route::currentRouteName() == 'admin.user.register') || (Route::currentRouteName() == 'user.index') ? 'active' : '' }}">
            ...
            <ul class="pcoded-submenu">
               <li class=" ">
                  <a href="{{ route('admin.user.register') }}">
                     <span class="pcoded-mtext">Subscribers Add</span>
                  </a>
               </li>
               <li class=" ">
